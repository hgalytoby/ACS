...
def upgrade() -> None:
    ...
    op.create_table(
        'ApiGroup',
        sa.Column(
            'name', sqlmodel.sql.sqltypes.AutoString(length=32), nullable=False
        ),
        sa.Column('id', UUID(), nullable=False),
        sa.Column('updated_at', sa.DateTime(), nullable=True),
        sa.Column('created_at', sa.DateTime(), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column(
            'value', sqlmodel.sql.sqltypes.AutoString(length=32), nullable=False
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            'blood_type', sqlmodel.sql.sqltypes.AutoString(), nullable=False
        ),
        ...
        sa.Column('created_at', sa.DateTime(), nullable=False),
        sa.Column(
            'image', sqlmodel.sql.sqltypes.AutoString(length=256), nullable=True
        ),
        sa.Column(
            'qrcode',
    ...
    op.create_table(
        ...
        sa.Column(
            'member_location_id', UUID(), nullable=False
        ),
        sa.Column(
        ...
        sa.Column(
            'member_phone', sqlmodel.sql.sqltypes.AutoString(), nullable=False
        ),
        sa.Column(
            'member_company',
            sqlmodel.sql.sqltypes.AutoString(length=32),
    ...
    op.create_table(
        ...
        sa.Column('created_at', sa.DateTime(), nullable=False),
        sa.Column(
            'uri', sqlmodel.sql.sqltypes.AutoString(length=128), nullable=False
        ),
        sa.Column(
            'description',
            sqlmodel.sql.sqltypes.AutoString(length=32),
    ...
    op.create_table(
        'FrontendLink',
        sa.Column('id', UUID(), nullable=False),
        sa.Column('frontend_id', UUID(), nullable=False),
    ...
    op.create_table(
        'ApiLink',
        sa.Column('id', UUID(), nullable=False),
        sa.Column('api_id', UUID(), nullable=False),
        sa.Column('role_id', UUID(), nullable=False),
        sa.Column('created_at', sa.DateTime(), nullable=False),
        sa.ForeignKeyConstraint(
            ['api_id'],
