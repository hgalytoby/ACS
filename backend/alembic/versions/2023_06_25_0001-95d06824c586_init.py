...
Revision ID: 95d06824c586
Revises: 
Create Date: 2023-06-25 00:01:44.647740
...
def upgrade() -> None:
    ...
    op.create_table('Api',
                    sa.Column('method', sqlalchemy_utils.types.choice.ChoiceType(UserLogEvent), nullable=True),
                    sa.Column('id', sqlmodel.sql.sqltypes.GUID(), nullable=False),
                    sa.Column('updated_at', sa.DateTime(), nullable=True),
                    sa.Column('created_at', sa.DateTime(), nullable=False),
    ...
    op.create_table('UserLog',
                    sa.Column('raw_data', postgresql.JSON(astext_type=sa.Text()), nullable=True),
                    sa.Column('event', sqlalchemy_utils.types.choice.ChoiceType(ApiMethod), nullable=True),
                    sa.Column('id', sqlmodel.sql.sqltypes.GUID(), nullable=False),
                    sa.Column('created_at', sa.DateTime(), nullable=False),
                    sa.Column('user_id', sqlmodel.sql.sqltypes.GUID(), nullable=False),
                    sa.ForeignKeyConstraint(['user_id'], ['User.id'], ),
